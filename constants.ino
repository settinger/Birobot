...
float l = 170; // This assumes all parallelograms are the same length
float h = 25; // Parallelogram width (UNUSED)
float sB = 123.4; // Length of side of base triangle
float sP = 110.3; // Length of side of actuator triangle
